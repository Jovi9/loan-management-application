...
Public Class rptBorrowersList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Loan_Management.rptBorrowersList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBorrowersList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBorrowersList = New rptBorrowersList()
        rpt.Site = Me.Site
        Return rpt
    End Function
