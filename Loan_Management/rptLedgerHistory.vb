...
Public Class rptLedgerHistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Loan_Management.rptLedgerHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLedgerHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLedgerHistory = New rptLedgerHistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
